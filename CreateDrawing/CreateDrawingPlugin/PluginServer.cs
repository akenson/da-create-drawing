...
{
    [Guid("ae57459d-6f25-491a-bf0a-b885f94863ce")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": CreateDrawingPlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
        ...
        {
            Trace.TraceInformation(": CreateDrawingPlugin: deactivating... ");
